<template>
  ...
  <p class="text-right text-primary text-xs mx-4">alpha v0.001</p>
  <div v-if="docs">  
    <Calendar :events="docs"/>
  </div>
  <div v-if="noDateEvent?.length" class="flex flex-col items-center text-center text-lg mt-2 text-violet">
