<template>
  <div class="flex flex-col items-center flex-grow justify-start my-2">
    ...
    <p class="mb-2">Events whitout a date are in :
      <span class="border border-violet rounded-md p-1 text-violet">violet</span>
    </p>
    <div class="flex flex-row justify-start flex-wrap" v-if="events.length">
